...
MDDTest_2a <- 
  MDDTest_2a |>
  mutate(Admit_TimeDiff = as.numeric(IPSD - AdmitDate))

MDDTest_2a <- 
  MDDTest_2a |>
  mutate(Discharge_TimeDiff = as.numeric(IPSD - DischargeDate))

# Test for admit and/or discharge date that is less than 60 days from the date of the IPSD
MDDTest_2a <- 
  MDDTest_2a |> 
