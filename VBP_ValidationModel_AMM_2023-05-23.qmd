...
The terms for the Validation Model for AMM are *Conceptual* and *Logical*. This model will help to define the systems surrounding measurement of AMM. This model also outlines a set of logical rules and structures of data to be used across agencies. 
...
The validation of VBP cases against adjudicated claims will tell us if the reports received through Health Choice's 3rd party vendor are reliable and valid. 
...
```{r}
#| label: Adjudicated Claims Unduplicated
#| eval: false
#| include: true
#| echo: true 
#| warning: false
...
AMMClaims_validation <- AMMEligibilityTest |> 
  select(MemberID,
         svccode)
