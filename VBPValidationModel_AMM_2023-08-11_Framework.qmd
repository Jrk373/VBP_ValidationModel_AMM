...
# write.csv(Enrollments_AllACC, "./data/output/Enrollments_AllACC.csv")
...
# write.csv(GM_ALLAZ_Enrollments, "./data/output/GM_AllAZ_Enrollments.csv")
...
# write.csv(GM_ALLAZ_Addresses, "./data/output/GM_AllAZ_Addresses.csv")
...
# write.csv(GM_PrimaryAssignedClinic, "./data/output/GM_PrimaryAssignedClinic.csv")
...
# write.csv(GM_HealthHomes, "./data/output/GM_HealthHomes.csv")
...
# write.csv(Clients_Demographics_AllACC, "./data/output/Clients.csv")
...
# write.csv(GM_DUGLess, "./data/output/DUGLess.csv")
...
# write.csv(AllTheVariables, "./data/AllTheVariables.csv")
